...
void patientRec(char currentUser[8]);
...
void patientMenu (void) //First Menu for Nurse
{
    while(getchar() == '\n')
    {
      char choice;
...
void personalMedInfo(char currentUser[8]) //This menu displays actions that can be performed for the Personal Medical Info
{
...
void patientMedChart(char currentUser[8]) //This menu displays actions that can be performed for the Patient Medical Chart
{
...
void patientMedHist(char currentUser[8]) //This menu displays actions that can be performed for the Patient Medical History
{
    if(currentUser == "Patient")
    {
        printf ("\n\nIt Worked Patient!!");
...
void ePrescript(char currentUser[8]) //This menu displays actions that can be performed for the E-Prescriptions
{
    if(currentUser == "Patient")
    {
        printf ("\n\nIt Worked Patient!!");
...
void vital(char currentUser[8]) //This menu displays actions that can be performed for the Patient's vitals
{
    if(currentUser == "Patient")
    {
        printf ("\n\nIt Worked Patient!!");
...
void logFunc(char currentUser[8]) //This menu displays actions that can be performed for the Auditor's Logs
{
...
void physicianOrder(char currentUser[8]) //This menu displays actions that can be displayed for the Personal Medical Info
{
    if(currentUser == "Doctor")
    {
        printf ("\n\nIt Worked Doctor!!"); 
...
void patientRec(char currentUser[8]) //This menu displays actions that can be displayed for the Personal Medical Info
{
...
void userAcc(char currentUser[8]) //This menu displays actions that can be displayed for the Personal Medical Info
{
    if(currentUser == "Admin")
    {
        printf ("\n\nIt Worked Admin!!"); 
